...
# Packages to install
PACKAGES=("stow" "make" "gcc" "ripgrep" "unzip" "xclip" "git" "neovim" "curl" "tmux" "nodejsl" "npm" "fzf" "noto-fonts" "i3-wm" "i3lock" "polybar" "i3blocks" "dmenu" "dunst" "kitty" "ttf-noto-nerd" "ttf-font-awesome" "ttf-nerd-fonts-symbols" "batsignal")
